...
export async function loadCloudDataFromSupabase(supabase, fallbackProducts = []) {
    const [{ data: products, error: productsError }, { data: movements, error: movementsError }, { data: orders, error: ordersError }, { data: auditLogs, error: auditLogsError }, { data: contracts, error: contractsError }] = await Promise.all([
